...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        const userResponse = await axios.get('https://pisafondo-production.up.railway.app/users/profile', {
          headers: { Authorization: `Bearer ${token}` },
        });

        const carsResponse = await axios.get('https://pisafondo-production.up.railway.app/cars/cochesUsuario/:id', {
          headers: { Authorization: `Bearer ${token}` },
        });
