  ...
  return (
    <section className="min-h-screen bg-apple-light flex items-center justify-center pt-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <a href="/app" className="inline-block bg-apple-accent text-white py-4 px-10 rounded-full text-lg font-medium hover:bg-blue-700 transition duration-300">Descubre Ahora</a>
      </div>
    </section>
  );
};
