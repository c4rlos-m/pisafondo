      ...
      <div className="text-center py-8">
        ...
        >
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={1.5}
            d="M8.707 6.707a1 1 0 011.414 0L12 8.586l1.879-1.879a1 1 0 111.414 1.414l-2.12 2.121a1.5 1.5 0 01-2.122 0L8.707 8.121a1 1 0 010-1.414z"
          />
        </svg>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {cars.map((car) => (
              <tr key={car.id}>
                ...
                <td className="px-4 py-4 whitespace-nowrap text-gray-500">{car.year}</td>
                <td className="px-4 py-4 whitespace-nowrap">
                  <span
                ...
                <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <Link to={`/app/coches/${car.id}`} className="text-blue-600 hover:text-blue-900 mr-3">
                    Ver
                  </Link>
